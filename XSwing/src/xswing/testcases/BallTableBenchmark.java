...
public class BallTableBenchmark {
	...
	private static List<Integer> listData = new ArrayList<Integer>(8 * 8);
	private static HashSet<Integer> hashData = new HashSet<Integer>(8 * 8);
	private static List<TestBall> ballData = new ArrayList<TestBall>(8 * 8);
