...
public interface Paths {
	...
	public static final String FONT_DIR = RES_DIR+"fonts/";
	/** Relative location of the sound dir */
	public static final String SOUND_DIR = RES_DIR+"sounds/";
	...
	public static final String RES_DIR_LIB = "lib/mylib/res/";
	/** Relative location of the resource dir for the tests */
	public static final String RES_TEST_DIR = "restest/";
